...
<article class="product mb-3 js-product-container">
    <div class="row align-items-end mb-3">
        ...
        <?php if (!empty($arResult["PROPERTIES"]["CML2_TRAITS"]["VALUE"])) : ?>
            <div class="col-3">
                <div class="row">
                    <div class="col-12">
                        <dl class="description-list description-list_row mb-0">
                            <div class="description-list__item d-flex justify-content-end">
                                ...
                                <dd class="description-list__value mb-0"><?php echo $arResult["PROPERTIES"]["CML2_TRAITS"]["VALUE"][2] ?></dd>
                            </div>
                        </dl>
                    </div>
                </div>
                    ...
                    <div class="product-prices__row">
                        ...
                        <?php if ($arResult["PROPERTIES"]["STARAYA_TSENA_PRI_SNIZHENII"]["VALUE"] !== "0") : ?>
                            <span class="product-prices__old me-3">
                                 <?php echo $arResult["PROPERTIES"]["STARAYA_TSENA_PRI_SNIZHENII"]["VALUE"] ?>&nbsp₽
                            </span>
                        <?php endif; ?>
                        <span class="product-prices__main">
                            <?php echo $arResult["PRICES"]["Типовые правила продаж"]["VALUE"] ?>&nbsp₽
                        </span>
                    </div>
                </div>
