        ...
        <ul class="list-reset">
            <? if ($arResult["bDescPageNumbering"] === true): ?>
                ...
                <? if ($arResult["NavPageNomer"] < $arResult["NavPageCount"]): ?>
                    <? if ($arResult["bSavePage"]): ?>
                        <li><a class="pagination__item pagination__item_icon pagination__item_icon_back"
                               href="<?= $arResult["sUrlPath"] ?>?<?= $strNavQueryString ?>PAGEN_<?= $arResult["NavNum"] ?>=<?= ($arResult["NavPageNomer"] + 1) ?>">
                                <svg width="12" height="12">
                                    <use xlink:href="#icon_arrow"></use>
                                </svg>
                            </a></li>
                        <li class=""><a class="pagination__item"
                    ...
                    <? else: ?>
                        ...
                        <? endif ?>
                        <li class=""><a class="pagination__item"
                                        href="<?= $arResult["sUrlPath"] ?><?= $strNavQueryStringFull ?>"><span>1</span></a>
                        </li>
                    <? endif ?>
                <? else: ?>
                    <li class="bx-pag-prev ppagination__item pagination__item_icon pagination__item_icon_back">
                        <svg width="12" height="12">
                            <use xlink:href="#icon_arrow"></use>
                        </svg>
                    </li>
                ...
                while ($arResult["nStartPage"] >= $arResult["nEndPage"] + 1):
                    ...
                    <li><a class="pagination__item" aria-current="true"
                           href="#"><span><?= $NavRecordGroupPrint ?></span></a></li>
                <? else:?>
                    <li class=""><a class="pagination__item"
                ...
                <? if ($arResult["NavPageNomer"] > 1): ?>
                    ...
                    <? endif ?>
                    <li class="bx-pag-next"><a class="pagination__item pagination__item_icon"
                ...
                <? else: ?>
                    <? if ($arResult["NavPageCount"] > 1): ?>
                        <li><a class="pagination__item" aria-current="true"
                               href="#"><span><?= $arResult["NavPageCount"] ?></span></a></li>
                    <? endif ?>
            ...
            <? else: ?>
                ...
                while ($arResult["nStartPage"] <= $arResult["nEndPage"] - 1):
                    ...
                    <? if ($arResult["nStartPage"] == $arResult["NavPageNomer"]):?>
                    <li><a class="pagination__item" aria-current="true"
                           href="#"><span><?= $arResult["nStartPage"] ?></span></a></li>
                <? else:?>
                    <li class=""><a class="pagination__item"
