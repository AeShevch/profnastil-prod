<?php
	...
	class Main
	{
		...
		const CATALOG_IBLOCK_ID = 86;
		const HL_PROPERTIES_BLOCK_ID = 4;
		...
		public static function getPropertiesRatio()
		{
			
			$entityPropertiesRatio = self::getEntityHLClass(self::HL_PROPERTIES_BLOCK_ID);
			
			try {
				
				return $entityPropertiesRatio::getList()->fetchAll();
		...
		public static function action()
		{
			...
			try {
				...
				$arPropertiesRatio = self::getPropertiesRatio();
